...
#template = rasterio.open(os.path.join(ras_dir,'Layout_Domain.tif'))
...
options = gdal.WarpOptions(options=['tr'], xRes=xres, yRes=yres,resampleAlg=resample_alg,multithread=True)
